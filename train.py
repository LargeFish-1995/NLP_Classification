...
if __name__=="__main__":
    ...
    parser.add_argument("--trainset", type=str, default="/mnt/lustre/yankun/temp/homework/deft_corpus/data/deft_files/train")
    parser.add_argument("--validset", type=str, default="/mnt/lustre/yankun/temp/homework/deft_corpus/data/deft_files/dev")
    args = parser.parse_args()

    device = 'cuda' if torch.cuda.is_available() else 'cpu'

    model = Net(args.top_rnns, len(VOCAB), device, args.finetuning).cuda()
